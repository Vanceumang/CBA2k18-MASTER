...
public class FriEvening extends AppCompatActivity {
    private static final String TAG = "MainActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fri_evening);

        ListView list = (ListView) findViewById(R.id.friEveningList);
        Log.d(TAG, "onCreate: Started.");

        ArrayList<String> names = new ArrayList<>();
        names.add("FRIDAY ZAAN KHAWM PROGRAM");
        ...
        ArrayAdapter adapter = new ArrayAdapter(this, R.layout.content_fri_evening, names);
