...
/**
 * Created by Van on 3/14/2018.
 */

public class PersonListAdapter extends ArrayAdapter<Places> {
     ...
     * @param objects
     */
    public PersonListAdapter(Context context, int resource, ArrayList<Places> objects) {
